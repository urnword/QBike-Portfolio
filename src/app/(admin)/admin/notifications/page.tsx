  ...
  return (
    <div className="px-4 py-6 sm:p-8 max-w-7xl mx-auto w-full bg-background min-h-screen">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
        <div>
          <h2 className="text-[22px] font-medium text-card-foreground">Admin Notifications</h2>
      ...
      {!notifications.length && !loading ? (
        <div className="bg-card rounded-2xl shadow-sm border border-border text-center max-w-md mx-auto p-12">
          ...
          <p className="text-[14px] text-muted-foreground mb-8 leading-relaxed">
            You&apos;re all caught up! Admin reports and alerts will appear here.
          </p>
          <Link href="/admin" className="bg-primary text-white px-8 py-3 rounded-xl font-medium text-sm hover:bg-primary/90 transition-all inline-block shadow-lg shadow-primary/20">
            Back to Dashboard
          </Link>
        </div>
      ) : loading ? (
